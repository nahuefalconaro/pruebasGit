...
export class FormReactiveComponent {
  ...
  formulario: FormGroup = this.fb.group({
    ...
    pais: [{ name: '', code: '' }, Validators.required],
    ...
    if (this.isAddAction) {
      ...
      this._activatedRouter.params
        ...
        .subscribe((contact: Contact) => {
          console.log('dentro subs', contact);
          ...
          this.formulario = this.fb.group({
            ...
            pais: [contact.pais, Validators.required], //validador personalizado
  ...
  addContact() {
    ...
    if (this.isAddAction) {
      ...
      this.contact.documento = String(Math.random() * 1000000);
